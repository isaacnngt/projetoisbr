 ...
 * @author Isaac Nunes
 */
public class LoginnTriagem extends javax.swing.JFrame {
    ...
    */
        ...
        String sql = "select * from usuarios where login=? and senha =?";
        {
            try {
                ...
                if (rs.next()) {
                    ...
                    TelaPrincipalTriagemGeral tela = new TelaPrincipalTriagemGeral();
                ...
                throw new RuntimeException("Erro no login. (Tela LoginnTriagem):" + e);
            }finally {
            try {
                rs.close();
                pst.close();
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jlData2, javax.swing.GroupLayout.PREFERRED_SIZE, 227, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(19, 19, 19))
        );
        ...
        jPanel2.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 200, 400, 430));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagensTelas/Enf.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoginnTriagem().setVisible(true);
            }
        });
    }
